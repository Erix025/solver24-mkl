...
MATRIX=../../dataset/solverchallenge24_09/solverchallenge24_09_A.mtx
VECTOR=../../dataset/solverchallenge24_09/solverchallenge24_09_b.rhs
# MATRIX=matrix.mtx
# VECTOR=rhs.rhs
echo $MATRIX $VECTOR
...
./build/direct_solver $MATRIX $VECTOR 1 1 0
